...
## How Codex changes appear in your VS Code

Yes — only after commits are pushed to GitHub and then you pull/fetch locally.

Flow:
1. Codex commit + push to branch on GitHub.
2. On your machine, run pull on same branch.
3. VS Code source tree refreshes and shows updated files.
